...
public class GeneralSoundsDatabase : ScriptableObject
{
    ...
    [SerializeField] private List<AudioClip> _generalObstacleHitSounds = new List<AudioClip>();
    ...
    public AudioClip ObstacleHit => _generalObstacleHitSounds[Random.Range(0, _generalObstacleHitSounds.Count)];
